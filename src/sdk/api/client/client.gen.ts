...
import {
  ...
  inject,
  // provideAppInitializer, // Not available in Angular 17.3
...
export const createClient = (config: Config = {}): Client => {
  ...
  const requestOptions = <ThrowOnError extends boolean = false, TResponseStyle extends ResponseStyle = 'fields'>(
